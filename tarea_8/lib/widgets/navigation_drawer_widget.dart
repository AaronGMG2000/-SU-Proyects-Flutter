                      ...
                      child: Material(
                        ...
                        child: ListView(
                          ...
                          children: [
                            ...
                            buildMenuItem(
                              text: locatizations
                                  .dictionary(Strings.perfilString),
                              icon: Icons.person,
                              onTap: () {
                            ...
                            buildMenuItem(
                              text: locatizations
                                  .dictionary(Strings.clientesString),
                              icon: Icons.people,
                              onTap: () {
                            ...
                            buildMenuItem(
                              text: locatizations
                                  .dictionary(Strings.segurosString),
                              icon: Icons.security,
                              onTap: () {
                                Navigator.pushReplacement(
                                  context,
                            ...
                            buildMenuItem(
                              text: locatizations
                                  .dictionary(Strings.siniestrosString),
                            ...
                            buildMenuItem(
                              text: locatizations
                                  .dictionary(Strings.tablaModificableString),
                              icon: Icons.assignment_late_outlined,
                              onTap: () {
                                Navigator.pushReplacement(
                                  context,
                            ...
                            buildMenuItem(
                              text: locatizations
                                  .dictionary(Strings.cerrarSesionString),
                              icon: Icons.logout,
                              onTap: () {
